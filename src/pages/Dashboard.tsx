        ...
        return {
          ...
          features: [
            ...
            },
            {
              ...
              icon: TrendingUp,
              action: () => toast({ title: "Coming soon!", description: "Market analysis feature" }),
            },
            {
              title: "Community",
              description: "Connect with other farmers and wholesalers",
              icon: Users,
              action: () => toast({ title: "Coming soon!", description: "Community feature" }),
            },
          ],
        };
      case "wholesaler":
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {content.features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="cursor-pointer hover:shadow-lg transition-all hover:scale-105 animate-grow"
